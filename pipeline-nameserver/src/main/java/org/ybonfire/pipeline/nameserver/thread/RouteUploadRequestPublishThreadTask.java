...
public final class RouteUploadRequestPublishThreadTask extends AbstractThreadTask {
    private final IRemotingRequest<RouteUploadRequest> request;
    private final PeerNode peer;
    private final CountDownLatch latch;
    private final INameServerClient client;

    RouteUploadRequestPublishThreadTask(final IRemotingRequest<RouteUploadRequest> request, final PeerNode peer,
    ...
    private void doPublish() {
        client.uploadRoute(peer.getAddress(), request, -1L);
    }
}

 ...
 */
public class NettyConnectEventHandler extends ChannelDuplexHandler {
    ...
    public void connect(final ChannelHandlerContext ctx, final SocketAddress remoteAddress,
        ...
        // 发布连接事件
        final NettyChannelEvent event = buildNettyChannelEvent(NettyChannelEventTypeEnum.OPEN, remote, ctx.channel());
    ...
    public void disconnect(final ChannelHandlerContext ctx, final ChannelPromise promise) throws Exception {
        ...
        // 发布关闭事件
        final NettyChannelEvent event = buildNettyChannelEvent(NettyChannelEventTypeEnum.CLOSE, remote, ctx.channel());
        channelEventHandleThreadService.putEvent(event);
    }
